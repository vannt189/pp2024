...
class SchoolManagement(Course,Student):
    ...
    def write_mark_info(self, course_id):
        with open(f"marks_{course_id}.txt","w") as f:
    ...
    def input_student_marks(self,course_id):
        ...
        self.write_mark_info(course_id)
    ...
    def studentMarkSheet(self):
        marksheet = [self.students, self.courses, self.marks]
